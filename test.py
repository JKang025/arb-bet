...
luckboxobj = objectify(luckboxscore, luckboxname, "Luckbox", 0)
...
pinobj = objectify(pinscore, pinname, "Pinnacle", len(luckboxobj))
...
print("LUCKBOXNAME")
print(luckboxname)
print("EDITED LUCKBOX")
print(luckbox_final_name)
print("--------------------------")
print("PINNAMES")
print(pinname)
print("EDITED PIN")
print(pin_final_name)
